...
import WelcomeGuestModal from '../molecules/WelcomeGuestModal'
                        ...
                        {isLoggedIn ? (
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button 
                                    ...
                                    className="border border-gray-400 text-gray-600 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-50 transition-colors cursor-pointer"
                                >
                                    Login as Guest
                                </button>
                            </div>
                        ...
                        <div className="px-4 py-4 space-y-4">
                            {isLoggedIn ? (
                                ...
                                <>
                                    ...
                                    <button 
                                        onClick={handleGuestLogin}
                                        className="block w-full border border-gray-400 text-gray-600 text-center px-4 py-3 rounded-md font-medium hover:bg-gray-50 transition-colors cursor-pointer"
                                    >
                                        Login as Guest
                                    </button>
                                </>
